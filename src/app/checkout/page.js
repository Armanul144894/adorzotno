                    ...
                    <div className="flex items-center justify-center">
                        <div className="flex items-center">
                            ...
                            <div className="flex items-center">
                                ...
                                <span className={`ml-2 font-semibold ${currentStep >= 1 ? 'text-primary' : 'text-gray-500'}`}>
                                    Shipping
                                </span>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <span className={`ml-2 font-semibold ${currentStep >= 2 ? 'text-primary' : 'text-gray-500'}`}>
                                    Payment
                                </span>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <span className={`ml-2 font-semibold ${currentStep >= 3 ? 'text-primary' : 'text-gray-500'}`}>
                                    Review
                                </span>
                            </div>
                        </div>
                        ...
                        {paymentMethod === 'card' && (
                            <form onSubmit={handlePaymentSubmit}>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <button
                                        type="submit"
                                        className="flex-1 bg-primary text-white py-4 rounded-lg font-semibold hover:bg-secondary transition flex items-center justify-center gap-2"
                                    >
                                        Review Order
                                        <ChevronRight size={20} />
                                    </button>
                        ...
                        {paymentMethod === 'paypal' && (
                            <div>
                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6 text-center">
                                    ...
                                    <div className="w-32 h-12 bg-primary rounded mx-auto mb-2"></div>
                                </div>
                                <div className="flex gap-4">
                                    <button
                                        onClick={() => setCurrentStep(1)}
                                    ...
                                    <button
                                        ...
                                        className="flex-1 bg-primary text-white py-4 rounded-lg font-semibold hover:bg-secondary transition"
                                    >
