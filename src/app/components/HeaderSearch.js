        ...
        <div className="flex w-full relative">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1 px-4 py-4 bg-gray-200 border border-gray-300 rounded-l-lg text-sm font-medium"
            >
              {selectedCategory}
              <ChevronDown size={16} />
            </button>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-blue-100 border-y border-primary focus:outline-none"
          />
