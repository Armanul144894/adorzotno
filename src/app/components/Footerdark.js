                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <p className="text-gray-400 text-sm"> Your trusted online pharmacy for quality healthcare products and medicines. </p> </div>
                        <div>
                    ...
                    {/* Bottom */}
                    <div className="border-t border-slate-400 mt-10 pt-6 text-center text-lg text-white">
