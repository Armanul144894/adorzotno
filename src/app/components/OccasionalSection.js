            ...
            <div className="bg-white rounded-b-lg shadow-md p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 2xl:grid-cols-6 gap-6">
                {occasion.products.map((product) => (
                  <div key={product.id} className="border border-red-200 rounded-lg overflow-hidden hover:shadow-lg transition">
                    ...
                    <div className="p-4">
                      ...
                      <button
                        className="w-full bg-gradient-to-r from-red-500 to-orange-500 text-white py-2 rounded-lg hover:from-red-600 hover:to-pink-600 transition font-semibold"
                      >
                        Add to Cart
                      </button>
                    </div>
