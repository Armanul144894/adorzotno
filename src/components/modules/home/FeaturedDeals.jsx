...
import { useGetFeaturedDealsQuery } from "@/redux/features/product/productApi";

export default function FeaturedDeals() {
  const { data: featuredDealsResponse = {}, isLoading, isFetching } =
  ...
  const featuredDeals = (featuredDealsResponse?.data || [])
